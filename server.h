...
#define PRINT_SERVER(str) PRINT_SERVER_FORMAT(str)
...
#define GETADDR_FOR_BIND(port, target_addrinfo) getaddr_for(NULL, port, SERVER_PREFIX, CONNECT_HINTS, target_addrinfo)
